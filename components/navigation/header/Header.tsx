          ...
          <div className="hidden md:flex-1 md:flex md:items-center md:justify-between">
            <Popover.Group as="nav" className="flex space-x-10">
              ...
              <Link href={`/blog/lastest`} >
                <a className={`text-base font-medium text-gray-500 hover:text-primary-100 ${activeLink("/blog/lastest")} `}>
                  Lastest
                </a>
              </Link>
                  ...
                  <>
                    <Popover.Button
                      className={classNames(
                        open ? 'text-primary-100' : 'text-gray-500',
                        'group bg-white rounded-md inline-flex items-center text-base font-medium hover:text-primary-100 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-100'
                      )}
                    >
                      <Link href={`/blog`} >
              ...
              <Link href={`/blog/category/1`} >
                <a className={`text-base font-medium text-gray-500 hover:text-primary-100 ${activeLink("/blog/category/1")}`}>
                  Career Path
                </a>
              </Link>
              ...
              <Popover className="relative">
                {({ open }: any) => (
                  <>
                    ...
                    >
                      <Link href={`/blog/category/2`} >
                        <a className={`${activeLink("/blog/category/2")}`}>Skill</a>
                      </Link>
                      <ChevronDownIcon
                        className={classNames(
                          open ? 'text-primary-100' : 'text-gray-400',
